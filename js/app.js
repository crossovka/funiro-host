 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            console.log("инит слайдерс вызвана");
            ...
            if (document.querySelector(".tips__slider")) new Swiper(".tips__slider", {
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                spaceBetween: 32,
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (window.innerWidth > 768 && isMobile.any()) {
                    if (targetElement.classList.contains("menu__arrow")) targetElement.closest(".menu__item").classList.toggle("_hovered");
                    if (!targetElement.closest(".menu__item") && document.querySelectorAll(".menu__item._hovered").length > 0) removeClasses(document.querySelectorAll(".menu__item._hovered"), "_hovered");
                }
                ...
                if (targetElement.classList.contains("actions-product__button")) {
                    const productId = targetElement.closest(".item-product").getAttribute("data-productId");
                    console.log("тип данных productId в docment actions: ", typeof productId);
                ...
                if (targetElement.classList.contains("cart-header__icon") || targetElement.closest(".cart-header__icon")) {
                    ...
                    e.preventDefault();
                } else if (!targetElement.closest(".cart-header") && !targetElement.classList.contains("actions-product__button") && document.querySelector(".cart-list").children.length > 0) {
                    document.querySelector(".cart-header").classList.remove("_active");
                    console.log("КОРЗИНА ЗАКРЫВАЕТСЯ");
                }
                if (targetElement.classList.contains("cart-list__delete")) {
                    const productId = targetElement.closest(".cart-list__item").getAttribute("data-cart-productId");
            ...
            function loadProducts(data) {
                ...
                data.products.forEach((item => {
                    const {id, url, title, text, labels, image, price, priceOld, shareUrl, likeUrl} = item;
                    let productTemplateStart = `<article class="products__item item-product" data-productId="${id}">`;
                    ...
                    if (labels) {
                        ...
                        labels.forEach((labelItem => {
                            const {type, value} = labelItem;
                            productTemplateLabelsContent += `<div class="item-product__label item-product__label_${type}">${value}</div>`;
                        }));
                        productTemplateLabels += productTemplateLabelStart;
                        productTemplateLabels += productTemplateLabelsContent;
                        productTemplateLabels += productTemplateLabelEnd;
                    }
                    let productTemplateImage = `\n\t\t\t <a href="${url}" class="item-product__image -ibg">\n\t\t\t\t <img src="../img/products/${image}" alt="${title}">\n\t\t\t </a>\n\t\t `;
                    let productTemplateBodyStart = `<div class="item-product__body">`;
                    let productTemplateBodyEnd = `</div>`;
                    let productTemplateContent = `\n\t\t\t <div class="item-product__content">\n\t\t\t\t <h5 class="item-product__title">${title}</h5>\n\t\t\t\t <div class="item-product__text">${text}</div>\n\t\t\t </div>\n\t\t\t `;
                    let productTemplatePrices = "";
                    let productTemplatePricesStart = `<div class="item-product__prices">`;
                    let productTemplatePricesCurrent = `<div class="item-product__price">${price}</div>`;
                    let productTemplatePricesOld = `<div class="item-product__price item-product__price_old">${priceOld}</div>`;
                    let productTemplatePricesEnd = `</div>`;
                    productTemplatePrices = productTemplatePricesStart;
                    productTemplatePrices += productTemplatePricesCurrent;
                    if (priceOld) productTemplatePrices += productTemplatePricesOld;
                    ...
                    productTemplateBody += productTemplateLabels;
            ...
            function updateCart(productButton, productId, productAdd = true) {
                ...
                if (productAdd) {
                    ...
                    if (!cartProduct) {
                        const product = document.querySelector(`[data-productId="${productId}"]`);
                        console.log("product в updateCart:", product);
                        const cartProductImage = product.querySelector(".item-product__image").innerHTML;
                        const cartProductTitle = product.querySelector(".item-product__title").innerHTML;
                        const cartProductContent = `\n\t\t\t <a href="#" class="cart-list__image -ibg">${cartProductImage}</a>\n\t\t\t <div class="cart-list__body">\n\t\t\t\t <a href="#" class="cart-list__title">${cartProductTitle}</a>\n\t\t\t\t<div class="cart-list__quantity">Quantity: <span>1</span> </div>\n\t\t\t\t<a href="#" class="cart-list__delete">Delete</a>\n\t\t\t </div>\n\t\t\t`;
                        cartList.insertAdjacentHTML("beforeend", `<li data-cart-productId="${productId}" class="cart-list__item">${cartProductContent}</li>`);
                    } else {
                    ...
                    console.log("cartProduct в update cart:", cartProduct);
                    const cartProductQuantity = cartProduct.querySelector(".cart-list__quantity span");
                    cartProductQuantity.innerHTML = --cartProductQuantity.innerHTML;
                    console.log("cartProductQuantity где ошибка вылезает:", cartProductQuantity);
                    if (!parseInt(cartProductQuantity.innerHTML)) {
                        console.log("cartProduct на момент удаления :", cartProduct);
                        cartProduct.remove();
                    }
                    const cartQuantityValue = --cartQuantity.innerHTML;
                    console.log("cartQuantityValue:", cartQuantityValue);
            ...
            if (furniture && !isMobile.any()) {
                ...
                function setMouseGalleryStyle() {
                    ...
                    const distX = Math.floor(coordinateXprocent - positionX);
                ...
                furniture.addEventListener("mousemove", (function(e) {
                    ...
                    coordinateXprocent = coordX / furnitureWidth * 200;
